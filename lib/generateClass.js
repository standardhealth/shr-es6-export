...
function writeToFhir(def, fhir, cw) {
  ...
  if(fhirProfile !== undefined){
   ...
   /* UNCOMMENT BELOW CODE TO JAM IN DUMMY MAPPING DATA */ 
    ...
    //   // addMapping('Patient.active', {'identity': 'shr', 'map': '<shr.fhir.BooleanValue>'}); // DONE
    ...
    //   addMapping('Practitioner.active', {'identity': 'shr', 'map': '<shr.fhir.DoubleNestedBooleanValue>.<shr.fhir.NestedBooleanValue>.<shr.fhir.BooleanValue>'});
    // }
