 ...
 * @return {string} a sanitized version of the name
 */
 ...
 * @return {string} a string representing the class name
 */
 ...
 * @return {string} a string representing the factory class name
 */
