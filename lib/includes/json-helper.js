 ...
 * @private
 */
export function createInstanceFromFHIR(key, value, allEntries=[], mappedResources={}, asExtension=false) {
  if (Array.isArray(value)) {
  ...
  if (typeof value === 'object') {
    ...
    return OBJECT_FACTORY.createInstanceFromFHIR(value, key, allEntries, mappedResources, asExtension);
  }
