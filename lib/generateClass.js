  ...
  if(fieldMapPath){
    ...
    for(const pathElement of fieldMapPath) {
      ...
      if (elementIdentifier.isEntryKeyWord || elementIdentifier.isConceptKeyWord) {
        ...
        // note that there is no instance of these in the current spec so this is not high priority
      ...
      if (!field) {
        ...
        console.error(`Original Element: ${def.identifier} ; full mapping: ${mapping} ; FHIR Path: ${element.path} ID: ${element.id || 'n/a'}`);
