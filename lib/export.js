...
class ES6Exporter {
  ...
  export() {
    ...
    for (const fileName of ['Reference.js', 'json-helper.js', 'init.js', 'fhirGeneralPurposeTypeMapping.js']) {
      es6Defs[fileName] = fs.readFileSync(path.join(__dirname, 'includes', fileName), 'utf8');
    }
