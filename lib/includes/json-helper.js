 ...
 * properties on the class instance.  If the JSON contains any properties that can't be found or set in the class,
 * an error will be sent to the console.
 * @param {object} _inst - an instance of an ES6 class for a specific element
 * @param {object} _fhirJson - a FHIR JSON object containing the date to set in the class
 */
export function setPropertiesFromFHIR(_inst, _fhirJson) {
